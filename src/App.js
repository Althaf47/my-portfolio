...
function App() {
  return (
    ...
    <img src={avatar} style={
      ...
      <About />
      <h4 className="d-flex justify-content-center m-5">Skills & Expertise</h4>
    ...
    <div className="container" style={{marginLeft:'23vw'}}>
              <ExpierienceBlock />
    </div>
      <BlockDetector/>
